...
| Images | Unsplash API | Source of all photo data |
| Icons | Font Awesome | UI icons (search, download, share, theme, alerts) |
| Typography | Google Fonts — Dancing Script | Logo wordmark |
